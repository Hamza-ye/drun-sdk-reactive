...
class Entity {
  ...
  static List<Column> getEntityColumns(
    ...
    for (String key in entityClassMirror
            .superclass?.superclass?.superclass?.declarations.keys ??
        []) {
      var value = entityClassMirror
          .superclass!.superclass!.superclass!.declarations[key];
